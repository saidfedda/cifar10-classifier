# app.py - ULTIMATE MODERN DESIGN WITH FULLY FUNCTIONAL SIDEBAR
# No hidden controls - sidebar toggle works perfectly
...
# ============================================
# CUSTOM CSS - STYLING ONLY (NO HIDING OF CONTROLS)
# ============================================
...
<style>
    ...
    * {
    ...
    /* Only hide the menu button and footer - NOT the sidebar toggle */
    #MainMenu {visibility: hidden;}
    footer {visibility: hidden;}
    
    /* Keep header visible because it contains the sidebar toggle button */
    /* Do NOT hide header */
    ...
    /* Sidebar styling - keep original functionality */
    ...
    /* Improve the appearance of the sidebar toggle button without breaking it */
    ...
    [data-testid="stSidebarCollapsedControl"]:hover {
        background: rgba(100, 150, 150, 0.5) !important;
...
# ============================================
# MODEL DEFINITIONS (simplified for brevity - keep your existing models)
# ============================================
...
with col_right:
    ...
    if uploaded:
        ...
        <div class="result-card">
            <div style="font-size: 2.2rem;">{predicted_class['emoji']}</div>
